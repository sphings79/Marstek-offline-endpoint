...
Es gibt ein fertiges Image für **amd64, arm64 und armv7** — läuft also auf einem
normalen Server genauso wie auf einem Raspberry Pi. Ein 3B reicht völlig; das
Ding beantwortet eine Handvoll Anfragen pro Stunde.
